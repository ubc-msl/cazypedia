<?php
/**
 * Cazypedia - New version of Vector with fresh look and many usability
 * improvements.
 *
 * @todo document
 * @file
 ...
 */
$wgValidSkinNames['cazypedia'] = 'Cazypedia';

/**
 * SkinTemplate class for Cazypedia skin
 * @ingroup Skins
 */
class SkinCazypedia extends SkinTemplate {

    var $skinname = 'Cazypedia', $stylename = 'vector',
        $template = 'CazypediaTemplate', $useHeadElement = true;        
    ...
    public function initPage( OutputPage $out ) {
        ...
        $out->addModuleScripts( 'skins.cazypedia' );
    }
    ...
    function setupSkinUserCss( OutputPage $out ){
        ...
        $out->addModuleStyles( 'skins.cazypedia' );
    }
}
 ...
 * @ingroup Skins
 */
class CazypediaTemplate extends BaseTemplate {
